...
class AppDelegate: NSObject, NSApplicationDelegate {
	...
	var blurryView = NSVisualEffectView(frame: NSRect(x: 0, y: 0, width: 240, height: 400))
	...
	func applicationDidFinishLaunching(_ aNotification: Notification) {
		...
		NSApp.mainWindow?.contentView?.addSubview(blurryView)
		*/
	}
	...
	lazy var applicationDocumentsDirectory: URL = {
	    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.oliverbarreto.testapp.DirectDialpad" in the user's Application Support directory.
	    let urls = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)
	    let appSupportURL = urls[urls.count - 1]
	    return appSupportURL.appendingPathComponent("com.oliverbarreto.testapp.DirectDialpad")
	}()

	lazy var managedObjectModel: NSManagedObjectModel = {
	    // The managed object model for the application. This property is not optional. It is a fatal error for the application not to be able to find and load its model.
	    let modelURL = Bundle.main.url(forResource: "DirectDialpad", withExtension: "momd")!
